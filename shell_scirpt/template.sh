...
case $1 in
    start)
        ...
        if [ ! -f $PID_PATH_NAME ]; then
            # cat /dev/null > /home/ubuntu/apps/apisample.log
            # nohup java $JAVA_OPT -jar $PATH_TO_JAR >> /home/ubuntu/apps/apisample.log &
    ...
    stop)
        if [ -f $PID_PATH_NAME ]; then
            ...
            rm $PID_PATH_NAME
            # rm /home/nalpari/public/apps/apisample.log
        else
