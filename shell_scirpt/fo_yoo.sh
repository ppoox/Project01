#!/bin/sh
SERVICE_NAME=fo_$2
PATH_TO_JAR=/home/ubuntu/apps_yoo/fo.jar
...
JAVA_OPT2=" -Dscouter.config=/home/ubuntu/scouter/scouter/agent.java/conf/scouter.conf -Dserver.port=38080 "
...
case $1 in
    start)
        ...
        if [ ! -f $PID_PATH_NAME ]; then
            ...
            nohup java $JAVA_OPT -jar $PATH_TO_JAR >> /home/ubuntu/logs/fo_$2.log &
