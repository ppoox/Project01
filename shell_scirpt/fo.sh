...
case $3 in
    1)
        echo 'SERVER_PORT = 38080'
        SERVER_PORT=38080
    ;;
    2)
        echo 'SERVER_PORT = 38081'
        SERVER_PORT=38081
    ;;
esac
...
case $1 in
    start)
        ...
        nohup java ${JAVA_OPTION} -jar ${PATH_TO_JAR} >> /home/ubuntu/logs/fo_$3.log &
    ;;
    stop)
        echo "Stop ${PID_NAME}"
    ...
    bakcup)
        echo 'Backup'
        mv /home/ubuntu/apps/deploy_fo.jar /home/ubuntu/backup/deploy_fo_backup.jar
    ;;
    change)
        echo 'Change'
        cp /home/ubuntu/tmp/deploy_fo_$2.jar /home/ubuntu/apps/deploy_fo.jar
    ;;
    remove)
        echo 'Remove'
        rm /home/ubuntu/tmp/deploy_fo_$2.jar
    ;;
esac
