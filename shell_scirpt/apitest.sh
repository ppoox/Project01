#!/bin/sh
SERVICE_NAME=apitest_$2
PATH_TO_JAR=/home/ubuntu/apps_yoo/apitest.jar
PID_PATH_NAME=/home/ubuntu/apps_yoo/apitest_$2.pid
PID_NAME=apitest_$2
PID_EXT=.pid
...
case $1 in
    start)
        ...
        if [ ! -f $PID_PATH_NAME ]; then
            ...
            nohup java $JAVA_OPT -jar $PATH_TO_JAR >> /home/ubuntu/logs/apitest_$2.log &
    ...
    stop)
        if [ -f $PID_PATH_NAME ]; then
            ...
            rm $PID_PATH_NAME
            rm /home/ubuntu/logs/apitest_$2.log
        else
